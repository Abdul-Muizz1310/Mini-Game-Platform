...
def open_game():
    ...
    frame_for_colour_selection = LabelFrame(cl_window, text="\tPLEASE SELECT A COLOUR", font=("calibri", 10), height=400,width=250, bd=5, bg="olivedrab1")
    ...
    frame_for_shape_and_colour = LabelFrame(cl_window, text="\t\tSELECT A SHAPE", height=400, width=250, bd=5,bg="lightskyblue1")
